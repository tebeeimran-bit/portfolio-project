                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    @if(($companyProfile->employees_cikarang ?? 0) > 0 || ($companyProfile->employees_cirebon ?? 0) > 0)
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="font-bold text-gray-800 mb-4 text-center border-b pb-2">Karyawan
                ...
                <div class="lg:col-span-9 space-y-8">
                        ...
                        <div class="md:col-span-1 flex flex-col items-center md:items-end space-y-4">
                            ...
                            @if($companyProfile->director_name || $companyProfile->director_image)
                                <div class="text-center w-48">
                                    <div
                                        class="bg-gray-200 h-56 rounded-lg overflow-hidden mb-2 shadow-lg border-2 border-gray-100">
                            ...
                            @if($companyProfile->triputra_dna_image)
                                <img src="{{ asset('storage/' . $companyProfile->triputra_dna_image) }}"
                    ...
                    @if($companyProfile->business_models && count($companyProfile->business_models) > 0)
                        <div class="text-center">
                            <h4
                                class="text-2xl font-bold text-blue-900 uppercase mb-8 border-b-2 border-blue-900 inline-block pb-1">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                                @foreach($companyProfile->business_models as $model)
                                    <div class="group">
                                        <div
                                            class="w-32 h-32 mx-auto rounded-full border-4 border-blue-900 flex items-center justify-center bg-white shadow-lg overflow-hidden relative mb-4 transition-transform group-hover:scale-110">
                                        ...
                                        <div
                                            class="bg-blue-900 text-white py-2 px-4 rounded-full text-sm font-bold mb-2 h-10 flex items-center justify-center min-w-[150px] mx-auto">
                                            {{ $model['title'] ?? 'Title' }}
                                        </div>
