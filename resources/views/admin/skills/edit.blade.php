...
<div class="page-header">
    <div class="page-header-row">
        <div>
            <h1>Edit Skill</h1>
            <p>Update informasi skill kategori {{ $skill->category }}.</p>
        </div>
    ...
    <form action="{{ route('admin.skills.update', $skill) }}" method="POST">
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            ...
            <select name="type" id="type" class="form-control" style="width: 100%; padding: 10px; border-radius: 6px; border: 1px solid var(--border-color); background: var(--bg-input); color: var(--text-primary);">
                <option value="technical" {{ old('type', $skill->type) === 'technical' ? 'selected' : '' }} style="background: #1f2937; color: #ffffff;">Technical Skill</option>
                <option value="soft" {{ old('type', $skill->type) === 'soft' ? 'selected' : '' }} style="background: #1f2937; color: #ffffff;">Soft Skill</option>
            </select>
            @error('type')
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            ...
            <div style="display: flex; gap: 10px;">
                <input type="text" name="category" id="category" value="{{ old('category', $skill->category) }}" class="form-control" style="flex: 1; padding: 10px; border-radius: 6px; border: 1px solid var(--border-color); background: var(--bg-input); color: var(--text-primary);">
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            ...
            <input type="text" name="category_en" id="category_en" value="{{ old('category_en', $skill->category_en) }}" class="form-control" style="width: 100%; padding: 10px; border-radius: 6px; border: 1px solid var(--border-color); background: var(--bg-input); color: var(--text-primary);">
        </div>
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            ...
            <textarea name="items" id="items" rows="3" class="form-control" style="width: 100%; padding: 10px; border-radius: 6px; border: 1px solid var(--border-color); background: var(--bg-input); color: var(--text-primary);">{{ old('items', $skill->items) }}</textarea>
            @error('items')
                <p style="color: #ef4444; font-size: 13px; margin-top: 4px;">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            ...
            <textarea name="items_en" id="items_en" rows="3" class="form-control" style="width: 100%; padding: 10px; border-radius: 6px; border: 1px solid var(--border-color); background: var(--bg-input); color: var(--text-primary);">{{ old('items_en', $skill->items_en) }}</textarea>
        </div>
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            ...
            <input type="number" name="order" id="order" value="{{ old('order', $skill->order) }}" class="form-control" style="width: 100%; padding: 10px; border-radius: 6px; border: 1px solid var(--border-color); background: var(--bg-input); color: var(--text-primary);">
